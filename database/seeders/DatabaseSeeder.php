...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $services = [
            ...
            ['categorie'=>'formation','nom'=>'Attestations & Certificats Automatisés','description'=>'Générez automatiquement des certificats PDF professionnels pour vos formations. Envoi par email ou WhatsApp avec QR code de vérification intégré.','prix_fcfa'=>75000,'prix_euro'=>115,'duree'=>'1 semaine','icone'=>'fas fa-certificate','popular'=>true,'actif'=>true,'features'=>json_encode(['Génération automatique de certificats PDF','Modèles personnalisés à votre image','QR code de vérification intégré','Envoi automatique par email ou WhatsApp','Gestion des participants et formations','Tableau de bord de suivi'])],
        ...
        $parametres = [
            ...
            ['cle'=>'site_email','valeur'=>'afrisds@gmail.com','groupe'=>'general'],
