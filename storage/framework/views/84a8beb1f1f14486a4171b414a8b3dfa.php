...
<div class="wrapper">
    ...
    <div class="header">
        ...
        <p>Merci pour votre intérêt, <?php echo e($guideDownload->organisation); ?> !</p>
    </div>

    <div class="body">
        <p class="greeting">Bonjour <?php echo e($guideDownload->nom); ?>,</p>
        <p class="text">
        ...
        <div class="btn-center">
            <a href="<?php echo e($downloadUrl); ?>" class="btn">Télécharger mon guide (PDF)</a>
        ...
        <div class="cta-secondary">
            <a href="<?php echo e(config('app.frontend_url', 'https://shalomdigitalsolutions.com')); ?>/contact" class="btn-outline">Demander une démonstration</a>
        </div>
    </div>
...
<?php /**PATH D:\ShalomDigitalSolutions\sds-backend\resources\views\emails\guide-visiteur.blade.php ENDPATH**/ ?>